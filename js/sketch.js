...
var chordA = ['C5', 'D#5', 'G5']
var chordB = ['C5', 'F5', 'A5']
var chordC = ['C5', 'E5', 'G5']
var chordProgression = [chordA, chordA, chordB, chordC]
...
AFRAME.registerComponent('swim-controls', {
  schema: {
    ...
    moveSpeed: { type: 'number', default: 0.5 }, // A-Frame units/second
  ...
  init: function () {
    ...
    document.addEventListener('keyup', function (eventData) {
      ...
      if (eventData.keyCode === 75) {
        self.el.children.guide.children.rightControls.children.kKey.setAttribute(
          'material',
          'src: #key; transparent: false; alphaTest: .5; color: white;'
        )
        self.el.children.guide.children.rightControls.children.kKey.children.letterK.setAttribute(
          'text',
          'color: white'
        )
        self.el.children.guide.children.rightControls.children.kKey.children.kGuide.setAttribute(
          'text',
          'opacity:0'
        )
      }
      ...
      if (eventData.keyCode === 68) {
        self.el.children.guide.children.leftControls.children.dKey.setAttribute(
          'material',
          'src: #key; transparent: false; alphaTest: .5; color: white;'
        )
        self.el.children.guide.children.leftControls.children.dKey.children.dGuide.setAttribute(
          'text',
          'opacity:0'
        )
        self.el.children.guide.children.leftControls.children.dKey.children.letterD.setAttribute(
          'text',
          'color: white'
        )
      }
      ...
      if (eventData.keyCode === 81) {
        self.el.children.guide.children.leftControls.children.qKey.setAttribute(
          'material',
          'src: #key; transparent: false; alphaTest: .5; color: white;'
        )
        self.el.children.guide.children.leftControls.children.qKey.children.letterQ.setAttribute(
          'text',
          'color: white'
        )
        self.el.children.guide.children.leftControls.children.qKey.children.qGuide.setAttribute(
          'text',
          'opacity:0'
        )
        var animeString =
          'property: rotation; to: 0 15 -5; dur: 200; easing: linear; loop: 2; dir: alternate'
      }

      //80 = p
      if (eventData.keyCode === 80) {
        self.el.children.guide.children.rightControls.children.pKey.setAttribute(
          'material',
          'src: #key; transparent: false; alphaTest: .5; color: white;'
        )
        self.el.children.guide.children.rightControls.children.pKey.children.letterP.setAttribute(
          'text',
          'color: white'
        )
        self.el.children.guide.children.rightControls.children.pKey.children.pGuide.setAttribute(
          'text',
          'opacity:0'
        )
        var animeString =
  ...
  tick: function (time, timeDelta) {
    ...
    if (this.isKeyPressed(this.data.pKey)) {
      this.el.children.guide.children.rightControls.children.pKey.setAttribute(
        'material',
        'src: #key; transparent: false; alphaTest: .5; color:#F2FD00;'
      )
      this.el.children.guide.children.rightControls.children.pKey.children.letterP.setAttribute(
        'text',
        'color: #F2FD00'
      )
      this.el.children.guide.children.rightControls.children.pKey.children.pGuide.setAttribute(
        'text',
        'opacity: 1'
      )
    }
    ...
    if (this.isKeyPressed(this.data.qKey)) {
      this.el.children.guide.children.leftControls.children.qKey.setAttribute(
        'material',
        'src: #key; transparent: false; alphaTest: .5; color:#F2FD00;'
      )
      this.el.children.guide.children.leftControls.children.qKey.children.letterQ.setAttribute(
        'text',
        'color: #F2FD00'
      )
      this.el.children.guide.children.leftControls.children.qKey.children.qGuide.setAttribute(
        'text',
        'opacity: 1'
      )
    }
    ...
    if (this.isKeyPressed(this.data.dKey)) {
      this.el.children.guide.children.leftControls.children.dKey.setAttribute(
        'material',
        'src: #key; transparent: false; alphaTest: .5; color:#F2FD00;'
      )
      this.el.children.guide.children.leftControls.children.dKey.children.letterD.setAttribute(
        'text',
        'color: #F2FD00'
      )
      this.el.children.guide.children.leftControls.children.dKey.children.dGuide.setAttribute(
        'text',
        'opacity: 1'
      )
    }
    ...
    if (this.isKeyPressed(this.data.kKey)) {
      this.el.children.guide.children.rightControls.children.kKey.setAttribute(
        'material',
        'src: #key; transparent: false; alphaTest: .5; color:#F2FD00;'
      )
      this.el.children.guide.children.rightControls.children.kKey.children.letterK.setAttribute(
        'text',
        'color: #F2FD00'
      )
      this.el.children.guide.children.rightControls.children.kKey.children.kGuide.setAttribute(
        'text',
        'opacity: 1'
      )
    }
